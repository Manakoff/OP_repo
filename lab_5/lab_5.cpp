...
int main()
{
	cout << "¬ведите пункт который хотите опробовать: " << endl;
	short pr;
	cin >> pr;
...
int fun(int number)
{
	cout << "‘ункци€ дл€ поиска ближайшого числа кратного 5" << endl;
	return round(number / 5) * 5;

}
int fun(int number_1, int number_2, int number_3)
{
	cout << "‘ункци€ дл€ нахождени€ суммы максимального и минимального числа " << endl;
